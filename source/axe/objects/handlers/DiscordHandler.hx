...
class DiscordHandler
{
	...
	public static function init():Void
	{
		...
		Discord.Initialize("1243718969635110993", cpp.RawPointer.addressOf(handlers), 1, null);
	...
	static function onReady(request:cpp.RawConstPointer<DiscordUser>):Void
	{
		...
		discordPresence.state = "AXE Engine";
		discordPresence.details = "In Engine";
		discordPresence.largeImageKey = "discordicon";
