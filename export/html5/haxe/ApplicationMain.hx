...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("AXE Engine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("AXE Engine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "4";
		app.meta["company"] = "Axuko / AXG Software";
		app.meta["file"] = "AXE Engine";
		app.meta["name"] = "AXE Engine";
		app.meta["packageName"] = "com.example.myapp";
		app.meta["version"] = "1.2.0";
