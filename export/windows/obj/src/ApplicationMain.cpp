...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("AXE Engine",54,de,44,24),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Axuko / AXG Software",46,13,5e,1a));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("AXE Engine",54,de,44,24));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("AXE Engine",54,de,44,24));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.example.myapp",84,30,57,c1));
HXLINE(  43)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("1.2.0",37,56,30,55));
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("AXE Engine",54,de,44,24))
